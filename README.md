...
- **歌词显示（逐字卡拉OK模式）**：点击展开后，歌词区以卡拉OK方式显示——**当前句的字逐个点亮**——高亮边界以「线性渐变 + 60fps 缓动」平滑扫过歌词，不是逐字硬切，无卡顿感（20px 大号 + 主题色高亮胶囊），其余句淡化，**平滑滚动自动居中**（60fps 逐帧逼近当前句，展开即自动跟随）；紧凑态左对齐实时显示当前句并同样逐字点亮；可选独立悬浮歌词小窗。
