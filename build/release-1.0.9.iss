; WinIsland - Universal Inno Setup installer for the 1.0.9 stable release (x64 + ARM64)
...
[Files]
Source: "..\..\releases\1.0.9\win-x64\WinIsland-1.0.9-win-x64.exe"; DestDir: "{app}"; DestName: "WinIsland.exe"; Flags: ignoreversion; Check: IsX64OS
Source: "..\..\releases\1.0.9\win-arm64\WinIsland-1.0.9-win-arm64.exe"; DestDir: "{app}"; DestName: "WinIsland.exe"; Flags: ignoreversion; Check: IsARM64
