; WinIsland - Universal Inno Setup installer for the 1.0.5 stable release (x64 + ARM64)
...
[Files]
Source: "..\..\releases\1.0.5\win-x64\WinIsland.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsX64OS
Source: "..\..\releases\1.0.5\win-arm64\WinIsland.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsARM64
