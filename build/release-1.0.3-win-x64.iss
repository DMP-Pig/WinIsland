; WinIsland - Inno Setup installer for the 1.0.3 stable release (win-x64)
#define MyAppName "WinIsland"
#define MyAppVersion "1.0.3"
#define MyAppPublisher "WinIsland"
#define MyAppExeName "WinIsland.exe"
#define SourceDir "..\..\releases\1.0.3\win-x64"
...
OutputBaseFilename=WinIsland-Setup-{#MyAppVersion}-win-x64
Compression=lzma2
